...
export default class App extends React.Component {
    ...
    fetchData = () =>
        fetch('/casos/infomapa/datoscovid').then((res) => res.json()).then((res) => {
