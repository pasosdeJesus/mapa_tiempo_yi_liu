...
export const CROATIA_ZH = '克罗地亚'
export const FINLAND_ZH = '芬兰'
export const UKRAINE_ZH = '乌克兰'
export const HUNGARY_ZH = '匈牙利'
export const SLOVAKIA_ZH = '斯洛伐克'
export const ALBANIA_ZH = '阿尔巴尼亚'
export const LATVIA_EN = 'Latvia'
export const LATVIA_ZH = '拉脱维亚'
export const GREECE_ZH = '希腊'
export const ESTONIA_ZH = '爱沙尼亚'
export const SLOVENIA_EN = 'Slovenia'
export const SLOVENIA_ZH = '斯洛文尼亚'
export const HAITI_ZH = '海地'
export const GHANA_ZH = '加纳'
export const ALGERIA_ZH = '阿尔及利亚'
export const NIGERIA_ZH = '尼日利亚'
export const SENEGAL_ZH = '塞内加尔'
export const MOROCCO_ZH = '摩洛哥'
export const BANGLADESH_ZH = '孟加拉国'
